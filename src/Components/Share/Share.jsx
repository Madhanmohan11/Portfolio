    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href="https://www.linkedin.com/in/madhan-m-25094b204/" aria-label="LinkedIn" data-social="linkedin" target="_blank" rel="noopener noreferrer">
        ...
        <li className="icon-content">
        <a href="https://github.com/Madhanmohan11" aria-label="GitHub" data-social="github" target="_blank" rel="noopener noreferrer">
            <div className="filled" />
        ...
        <li className="icon-content">
        <a href="https://api.whatsapp.com/send?phone=+919150387980" aria-label="Whatsapp" data-social="whatsapp" target="_blank" rel="noopener noreferrer">
            <div className="filled" />
